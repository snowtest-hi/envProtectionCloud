...
public class AutoMail {
	public static void main(String[] args) throws AddressException, FileNotFoundException, IOException {
		...
		mailInfo.setMailServerHost(ReadProperties.getProperty("mail", "MailServerHost"));
		mailInfo.setMailServerPort(ReadProperties.getProperty("mail", "MailServerPort"));
		mailInfo.setValidate(true);
		mailInfo.setUsername(ReadProperties.getProperty("mail", "Username"));
		mailInfo.setPassword(ReadProperties.getProperty("mail", "Password"));// 您的邮箱密码
		mailInfo.setFromAddress(ReadProperties.getProperty("mail", "FromAddress"));
		mailInfo.setToAddress(sendTo);
		mailInfo.setSubject(ReadProperties.getProperty("mail", "Subject"));
